...
import AdminEventManage from  './admin/event/eventManage';
import CreateEvent from './admin/event/eventManage/CreateEvent';
import EditEvent from './admin/event/eventManage/EditEvent';
import AdminEventReg from './admin/event/eventReg';
//////////////////////////////////
///// OTHER SECTION
            ...
            <div>
                <Router history={history}>
                    <Switch>
                        ...
                        <ProtectedAdminRoute path="/admin/event/manage" exact  component={AdminEventManage} />
